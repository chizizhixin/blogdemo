...
<nav class="blog-nav layui-header">
  <div class="blog-container">
    ...
    <ul class="layui-nav" lay-filter="nav">
      ...
      <li class="layui-nav-item">
        <a href="timeline.jsp"><i class="fa fa-hourglass-half fa-fw"></i>&nbsp;点点滴滴</a>
      </li>
...
pagesize(laypageId, pageSize).callback(function (newPageSize) {
    ...
    //你可以在这里使用新的页容量重新获取分页数据！
});</pre> &nbsp;&nbsp; &nbsp;<span style="color:#EE33EE;">参数说明</span>：
            <p>
            ...
            <p>
              &nbsp;&nbsp;&nbsp;&nbsp;该功能是我后台分页的时候扩展的一个功能，但我又想将它分享出来，于是做成了layui扩展模块。<br /> &nbsp;&nbsp;&nbsp;&nbsp;由于它起初针对我个人后台的分页定制的扩展功能，所以我只测试了我分页的写法是能实现的，并不知道大家的分页写法是否能用！
              <br /> &nbsp;&nbsp;&nbsp;&nbsp;如不能用，请参考我后台的分页写法！
              <br /> &nbsp;&nbsp;&nbsp;&nbsp;后台暂时没有源码，没时间整理，所以请自行到后台查看！
            </p>
            <hr />
            <p>
              <br />
            ...
            <p>
              &nbsp; &nbsp; 点赞不落阁：<a href="http://fly.layui.com/case/2017/" target="_blank"><span style="color:#337FE5;">点击前往</span></a>&nbsp; &nbsp; 完整演示请看后台：<span><a href="http://www.lyblogs.cn/admin" target="_blank"><span style="color:#337FE5;">点击前往</span></a>
                                </span>&nbsp; &nbsp; pagesize.js下载地址：<a href="https://pan.baidu.com/s/1kVK8UhT" target="_blank"><span style="color:#337FE5;">点击前往</span></a>
            </p>
            <hr /> &nbsp; &nbsp; 出自：不落阁
            <p>
